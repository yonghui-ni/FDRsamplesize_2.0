...
Step by step to calculate power and sample size. This procedure is more flexible for user to plug in self-defined power function and average power calculation function for other statistical tests that not involved in *FDRsamplesize2*
```{r}
